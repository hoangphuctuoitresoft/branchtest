{{-- <div class="ps-contact-form">
    ...
    <form id="widget-subscribe-form" action="include/subscribe.php" method="post" class="mt-1 mb-0 d-flex">
        <input type="email" id="widget-subscribe-form-email" name="widget-subscribe-form-email" class="form-control sm-form-control required email" placeholder="Nhập địa chỉ Email của bạn">

        <button class="button nott font-weight-normal ml-1 my-0" type="submit">Theo Dõi Ngay</button>
    </form>
</div>
