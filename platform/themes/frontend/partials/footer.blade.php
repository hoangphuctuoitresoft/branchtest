			...
			<div class="container clearfix">
				...
				<div class="footer-widgets-wrap pb-3 border-bottom clearfix">
					...
					<div class="row">
                        ...
                        {!! Theme::partial('menu-footer') !!}
						
						<div class="col-lg-4 col-md-8">
							<div class="widget clearfix">

                                {!! Theme::partial('footer-text') !!}
				...
				<div class="container clearfix">
					...
					<div class="row justify-content-between align-items-center">
						<div class="col-md-6">
							...
							<div class="copyright-links"><a href="#">Điều khoản sử dụng</a> / <a href="#">Chính sách bảo mật</a></div>
						</div>

						<div class="col-md-6 d-md-flex flex-md-column align-items-md-end mt-4 mt-md-0">
							<div class="copyrights-menu copyright-links clearfix">
								<a href="#">Về chúng tôi</a>/<a href="#">Đặc trưng</a>/<a href="#">Các câu hỏi thường gặp</a>/<a href="#">Liên hệ</a>
							</div>
						</div>
					</div>
