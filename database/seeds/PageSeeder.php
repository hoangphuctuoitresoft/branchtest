        ...
        $pages = [
            [
                ...
                'content'  =>
                    ...
                    Html::tag('div',
                        '[theme-ads key_1="homepage-middle-1" key_2="homepage-middle-2" key_3="homepage-middle-3"][/theme-ads]') .
                    Html::tag('div', '[featured-products title="Featured products"][/featured-products]') .
                    Html::tag('div',
                        '[theme-ads key_1="homepage-bottom-big" key_2="homepage-bottom-big"][/theme-ads]') .
                    ...
                    Html::tag('div',
                        '[download-app title="Download Martfury App Now!" description="Shopping fastly and easily more with our app. Get a link to download the app on your phone." screenshot="general/app.png" android_app_url="#" ios_app_url="#"][[/download-app]') .
